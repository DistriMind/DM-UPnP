...
package fr.distrimind.oss.upnp.android.transport.spi;
...
public interface ServletContainerAdapter {
    ...
    /**
     * Might be called several times to integrate the servlet container with DM-UPnP's executor
     * configuration. You can ignore this call if you want to configure the container's thread
     * pooling independently of DM-UPnP. If you use the given DM-UPnP <code>ExecutorService</code>,
     ...
     * and the port DM-UPnP expects to receive HTTP requests on. If you set up your HTTP
     * server connectors elsewhere and ignore when DM-UPnP calls this method, make sure
     * you configure DM-UPnP with the correct host/port of your servlet container.
     *
