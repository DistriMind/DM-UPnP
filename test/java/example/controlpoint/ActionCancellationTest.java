 ...
 * will simply be interrupted. If you are calling a remote service, DM-UPnP will abort the HTTP request to the server.
 * </p>
 * <p>
 ...
 * return the response to the client on the closed connection. DM-UPnP's server transports offer a special heartbeat
 ...
 * </p>
 * <p>
 * Not all HTTP client transports in DM-UPnP support interruption of requests:
 * </p>
