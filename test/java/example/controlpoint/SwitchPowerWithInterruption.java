 ...
 *
 * <p>
 * You abort processing by throwing an <code>InterruptedException</code>, DM-UPnP will do the rest. DM-UPnP will send
 ...
 * </p>
 * <p>
 * <em>Danger:</em> Not all HTTP clients can deal with DM-UPnP's heartbeat signal. Not even all bundled
 * <code>StreamClient</code>'s of DM-UPnP can handle such a signal. You should only use this feature if you are sure that
 * all clients of your service will ignore the meaningless heartbeat signal. DM-UPnP sends a space character (this is
 ...
 * </p>
 * <p>
 * The following DM-UPnP-bundled client transports can deal with a heartbeat signal:
 * </p>
 ...
 * </table>
 * <p>
 * Equally important, not all server transports in DM-UPnP can send heartbeat signals, as low-level socket access is
