 ...
 * </p>
 * <p>
 * The "related statevariable" detection algorithm in DM-UPnP has one more trick
 ...
 * related state variable of your action argument, DM-UPnP will also
 * look for a state variable with the name
 * <code>A_ARG_TYPE_[Name Of Your Argument]</code>. In the example above, DM-UPnP
