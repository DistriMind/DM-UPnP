 ...
 * </div>
 * <p>
 * DM-UPnP tries to provide smart defaults. For example, the previously shown service classes
 * did not name the related state variable of action output arguments, as required by UPnP.
 * DM-UPnP will automatically detect that the <code>getStatus()</code> method is a JavaBean
 ...
 * the JavaBean property <code>status</code> and DM-UPnP is also smart enough to know that
 ...
 * redesign and rewrite your class without interrupting all existing code. DM-UPnP offers
