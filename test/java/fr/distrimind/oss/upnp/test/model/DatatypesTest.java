...
package fr.distrimind.oss.upnp.test.model;

import fr.distrimind.oss.upnp.model.types.Base64Datatype;
import fr.distrimind.oss.upnp.model.types.DLNADoc;
import fr.distrimind.oss.upnp.model.types.Datatype;
import fr.distrimind.oss.upnp.model.types.DateTimeDatatype;
import fr.distrimind.oss.upnp.model.types.DoubleDatatype;
import fr.distrimind.oss.upnp.model.types.FloatDatatype;
import fr.distrimind.oss.upnp.model.types.IntegerDatatype;
import fr.distrimind.oss.upnp.model.types.InvalidValueException;
import fr.distrimind.oss.upnp.model.types.UnsignedIntegerFourBytesDatatype;
import fr.distrimind.oss.upnp.model.types.UnsignedIntegerOneByteDatatype;
import fr.distrimind.oss.upnp.model.types.UnsignedIntegerTwoBytesDatatype;
import fr.distrimind.oss.upnp.model.types.csv.CSVBoolean;
import fr.distrimind.oss.upnp.model.types.csv.CSVString;
