...
package fr.distrimind.oss.upnp.support.shared;
...
import fr.distrimind.oss.upnp.swing.logging.LogCategory;
    ...
    public CoreLogCategories() {
        ...
        add(new LogCategory("UPnP Protocol", new LogCategory.Group[]{
                ...
                new LogCategory.Group(
                        ...
                        new LogCategory.LoggerLevel[]{
                                ...
                                new LogCategory.LoggerLevel("fr.distrimind.oss.upnp.protocol.async", Level.TRACE)
                        }
                ),
                ...
                new LogCategory.Group(
                        "GENA ",
                        new LogCategory.LoggerLevel[]{
                                new LogCategory.LoggerLevel("fr.distrimind.oss.upnp.model.gena", Level.TRACE),
                                new LogCategory.LoggerLevel(ProtocolFactory.class.getName(), Level.TRACE),
        ...
        add(new LogCategory("Core", new LogCategory.Group[]{
                ...
                new LogCategory.Group(
                        ...
                        new LogCategory.LoggerLevel[]{
                                new LogCategory.LoggerLevel("fr.distrimind.oss.upnp.binding.annotations", Level.TRACE),
                                new LogCategory.LoggerLevel(LocalService.class.getName(), Level.TRACE),
                                new LogCategory.LoggerLevel("fr.distrimind.oss.upnp.model.action", Level.TRACE),
                                new LogCategory.LoggerLevel("fr.distrimind.oss.upnp.model.state", Level.TRACE),
                ...
                new LogCategory.Group(
                        ...
                        new LogCategory.LoggerLevel[]{
                                new LogCategory.LoggerLevel("fr.distrimind.oss.upnp.controlpoint", Level.TRACE),
                        }
                ),
        }));
