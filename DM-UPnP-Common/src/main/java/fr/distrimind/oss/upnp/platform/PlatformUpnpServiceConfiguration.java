...
package fr.distrimind.oss.upnp.platform;
...
import fr.distrimind.oss.upnp.transport.impl.*;
import fr.distrimind.oss.upnp.transport.spi.*;
...
public abstract class PlatformUpnpServiceConfiguration {
	...
	static
	{
		...
		try {
			@SuppressWarnings("unchecked") Class<? extends PlatformUpnpServiceConfiguration> c=(Class<? extends PlatformUpnpServiceConfiguration>)Class.forName("fr.distrimind.oss.upnp.android.platform.AndroidPlatformUpnpServiceConfiguration");
		...
		constructor=null;
		try {
			@SuppressWarnings("unchecked") Class<? extends PlatformUpnpServiceConfiguration> c=(Class<? extends PlatformUpnpServiceConfiguration>)Class.forName("fr.distrimind.oss.upnp.desktop.platform.DesktopPlatformUpnpServiceConfiguration");
			constructor=c.getConstructor();
		} catch (ClassNotFoundException | NoSuchMethodException ignored) {
		}
		...
		switch (platform)
		{
			case ANDROID:
				if (androidPlaformConstructor==null)
					throw new RuntimeException("The class fr.distrimind.oss.upnp.android.platform.AndroidPlatformUpnpServiceConfiguration was not found. Please import DM-UPnP-Android library.");
				constructor=androidPlaformConstructor;
				break;
			case DESKTOP:
				if (desktopPlaformConstructor==null)
					throw new RuntimeException("fr.distrimind.oss.upnp.desktop.platform.DesktopPlatformUpnpServiceConfiguration was not found. Please import DM-UPnP-Desktop library.");
