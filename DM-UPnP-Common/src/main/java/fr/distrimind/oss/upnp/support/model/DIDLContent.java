...
import fr.distrimind.oss.upnp.support.model.container.Album;
import fr.distrimind.oss.upnp.support.model.container.Container;
import fr.distrimind.oss.upnp.support.model.container.GenreContainer;
import fr.distrimind.oss.upnp.support.model.container.MovieGenre;
import fr.distrimind.oss.upnp.support.model.container.MusicAlbum;
import fr.distrimind.oss.upnp.support.model.container.MusicArtist;
import fr.distrimind.oss.upnp.support.model.container.MusicGenre;
import fr.distrimind.oss.upnp.support.model.container.PersonContainer;
import fr.distrimind.oss.upnp.support.model.container.PhotoAlbum;
import fr.distrimind.oss.upnp.support.model.container.PlaylistContainer;
import fr.distrimind.oss.upnp.support.model.container.StorageFolder;
import fr.distrimind.oss.upnp.support.model.container.StorageSystem;
import fr.distrimind.oss.upnp.support.model.container.StorageVolume;
import fr.distrimind.oss.upnp.support.model.item.AudioBook;
import fr.distrimind.oss.upnp.support.model.item.AudioBroadcast;
import fr.distrimind.oss.upnp.support.model.item.AudioItem;
import fr.distrimind.oss.upnp.support.model.item.ImageItem;
import fr.distrimind.oss.upnp.support.model.item.Item;
import fr.distrimind.oss.upnp.support.model.item.Movie;
import fr.distrimind.oss.upnp.support.model.item.MusicTrack;
import fr.distrimind.oss.upnp.support.model.item.MusicVideoClip;
import fr.distrimind.oss.upnp.support.model.item.Photo;
import fr.distrimind.oss.upnp.support.model.item.PlaylistItem;
import fr.distrimind.oss.upnp.support.model.item.TextItem;
import fr.distrimind.oss.upnp.support.model.item.VideoBroadcast;
import fr.distrimind.oss.upnp.support.model.item.VideoItem;
