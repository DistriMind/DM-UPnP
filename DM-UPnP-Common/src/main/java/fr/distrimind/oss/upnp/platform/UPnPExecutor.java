...
public class UPnPExecutor extends ThreadPoolExecutor {
	final private static DMLogger log = Log.getLogger(UPnPExecutor.class);

	public UPnPExecutor() {
		this(new UPnPThreadFactory(),
	...
	public UPnPExecutor(ThreadFactory threadFactory, RejectedExecutionHandler rejectedHandler) {
