...
package fr.distrimind.oss.upnp.support.avtransport.lastchange;

import fr.distrimind.oss.upnp.model.types.UnsignedIntegerFourBytes;
import fr.distrimind.oss.upnp.support.model.*;
import fr.distrimind.oss.upnp.support.lastchange.EventedValue;
import fr.distrimind.oss.upnp.support.lastchange.EventedValueEnum;
import fr.distrimind.oss.upnp.support.lastchange.EventedValueEnumArray;
import fr.distrimind.oss.upnp.support.lastchange.EventedValueString;
import fr.distrimind.oss.upnp.support.lastchange.EventedValueURI;
import fr.distrimind.oss.upnp.support.lastchange.EventedValueUnsignedIntegerFourBytes;
...
public class AVTransportVariable {
    ...
    public static class TransportState extends EventedValueEnum<fr.distrimind.oss.upnp.support.model.TransportState> {
        public TransportState(fr.distrimind.oss.upnp.support.model.TransportState avTransportState) {
        ...
        @Override
        protected fr.distrimind.oss.upnp.support.model.TransportState enumValueOf(String s) {
            return fr.distrimind.oss.upnp.support.model.TransportState.valueOf(s);
        }
    }

    public static class TransportStatus extends EventedValueEnum<fr.distrimind.oss.upnp.support.model.TransportStatus> {
        public TransportStatus(fr.distrimind.oss.upnp.support.model.TransportStatus transportStatus) {
        ...
        @Override
        protected fr.distrimind.oss.upnp.support.model.TransportStatus enumValueOf(String s) {
            return fr.distrimind.oss.upnp.support.model.TransportStatus.valueOf(s);
        }
    }
    ...
    public static class RecordMediumWriteStatus extends EventedValueEnum<fr.distrimind.oss.upnp.support.model.RecordMediumWriteStatus> {
        public RecordMediumWriteStatus(fr.distrimind.oss.upnp.support.model.RecordMediumWriteStatus recordMediumWriteStatus) {
        ...
        @Override
        protected fr.distrimind.oss.upnp.support.model.RecordMediumWriteStatus enumValueOf(String s) {
            return fr.distrimind.oss.upnp.support.model.RecordMediumWriteStatus.valueOf(s);
        }
    }
