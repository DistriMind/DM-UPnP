...
package fr.distrimind.oss.upnp.binding.xml;
...
import fr.distrimind.oss.upnp.binding.staging.MutableAction;
import fr.distrimind.oss.upnp.binding.staging.MutableActionArgument;
import fr.distrimind.oss.upnp.binding.staging.MutableAllowedValueRange;
import fr.distrimind.oss.upnp.binding.staging.MutableService;
import fr.distrimind.oss.upnp.binding.staging.MutableStateVariable;
...
import fr.distrimind.oss.upnp.model.types.CustomDatatype;
...
import static fr.distrimind.oss.upnp.binding.xml.Descriptor.Service.ATTRIBUTE;
import static fr.distrimind.oss.upnp.binding.xml.Descriptor.Service.ELEMENT;
import static fr.distrimind.oss.upnp.model.XMLUtil.appendNewElementIfNotNull;
