...
import fr.distrimind.oss.upnp.model.message.discovery.OutgoingSearchResponse;
import fr.distrimind.oss.upnp.model.message.discovery.OutgoingSearchResponseDeviceType;
import fr.distrimind.oss.upnp.model.message.discovery.OutgoingSearchResponseRootDevice;
import fr.distrimind.oss.upnp.model.message.discovery.OutgoingSearchResponseServiceType;
import fr.distrimind.oss.upnp.model.message.discovery.OutgoingSearchResponseUDN;
