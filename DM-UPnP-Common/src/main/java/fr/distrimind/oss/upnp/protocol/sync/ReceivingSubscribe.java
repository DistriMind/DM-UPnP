...
import fr.distrimind.oss.upnp.model.message.gena.IncomingSubscribeRequestMessage;
import fr.distrimind.oss.upnp.model.message.gena.OutgoingSubscribeResponseMessage;
