		...
		switch (platform)
		{
			case ANDROID:
				if (androidPlaformConstructor==null)
					throw new RuntimeException("The class com.distrimind.upnp.android.platform.AndroidPlatformUpnpServiceConfiguration was not found. Please import DM-UPnP-Android library.");
				constructor=androidPlaformConstructor;
				break;
			case DESKTOP:
				if (desktopPlaformConstructor==null)
					throw new RuntimeException("com.distrimind.upnp.desktop.platform.DesktopPlatformUpnpServiceConfiguration was not found. Please import DM-UPnP-Desktop library.");
